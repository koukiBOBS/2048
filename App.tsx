  ...
  return (
    ...
    >
      <div className="w-full h-full flex flex-col landscape:flex-row items-center justify-center gap-6 md:gap-12 landscape:gap-8 max-w-[500px] landscape:max-w-none">
        ...
        {/* 
            Changes: 
            1. Removed 'aspect-square' from base classes to stop Portrait mode from forcing a square container height if flex stretches it.
            2. Kept 'portrait:max-w-[65vh]' to limit width on short screens.
            3. Added 'landscape:aspect-square' because in landscape we fix height and want width to follow.
        */}
        <div 
            ref={boardRef}
